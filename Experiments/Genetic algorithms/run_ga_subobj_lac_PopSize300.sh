...
module load matlab
# Run script
matlab -nodisplay -nosplash -r "addpath('cobratoolbox/'); initCobraToolbox; GA_subtraction_object_cmdarg sub_object_lac_pop300 1e-4 0.85 300 12 1000 EX_Dlactate_D; exit"
